# -*- coding: utf-8 -*-
"""
Created on Wed May  3 10:50:17 2023
...
def RBF_network_proto_and_nontremor_train(data, outcomevar, protovar, non_tremor_classes_var, h, d):
    ...
    return C, Beta, rbf_model, train_prediction, clf

def RBF_network_proto_and_nontremor_predict(data, outcomevar, protovar, non_tremor_classes_var, h, rbf_model, model, C, Beta):
